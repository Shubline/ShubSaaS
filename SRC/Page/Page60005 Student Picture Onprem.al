    ...
    layout
    {
        area(content)
        {
            field(Image; Rec.Image)
            {
                ApplicationArea = All;
                ShowCaption = false;
                ToolTip = 'Specifies the picture of the Student, for example, a logo.';
            }
        }
    }
        ...
        area(processing)
        {
            ...
            action(ExportFile)
            {
                ...
                var
                    ...
                    ExportPath: Text;
                begin
                    Rec.TestField(Rec."Addmission No.");
                    Rec.TestField(Rec.Name);

                    ToFile := DummyPictureEntity.GetDefaultMediaDescription(Rec);
                    // ExportPath := TemporaryPath + Rec."Addmission No." + Format(Rec.Image.MediaId);
