page 50001 "E-Invoice (Sales Invoice)"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Administration;
    SourceTable = "E-Invoice & E-Way Bill";
    SourceTableView = WHERE("Transaction Type" = FILTER('Sales Invoice'));
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("E-way bill Cancel Remarks"; Rec."E-way bill Cancel Remarks")
                {
                    ApplicationArea = all;
                    Editable = true;
                ...
                field("Cancel Reason E-Way By Irn"; Rec."Cancel Reason E-Way By Irn")
                {
                    ApplicationArea = All;
                ...
                field("Standalone E way bill Pdf"; Rec."Standalone E way bill Pdf")
                {
                    ApplicationArea = All;
                    Caption = 'Standalone E way bill Pdf';
                    Editable = false;
                }
                field("StandaloneE-Way Bill Report URL"; Rec."StandaloneEWay Bill Report URL")
                {
                    ApplicationArea = all;
                    Editable = false;
                }
