table 50002 "GST Integration Setup"
{
    ...
    fields
    {
        ...
        field(5; "URL to Cancel Eway-Invoice"; Text[2000])
        {
            DataClassification = ToBeClassified;
            Caption = 'URL to Cancel Eway-Invoice';
        }
        field(6; "URL to Print Eway-Invoice"; Text[2000])
        {
            DataClassification = ToBeClassified;
